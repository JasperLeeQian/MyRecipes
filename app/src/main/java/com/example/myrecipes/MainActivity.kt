...
import com.example.myrecipes.view.SharedRecipeActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val randomMealButton: Button = findViewById(R.id.button_random_recipes)
        randomMealButton.setOnClickListener {
            val intent = Intent(this, RandomMealActivity::class.java)
            startActivity(intent)
        }

// Button to navigate to SharedRecipesActivity
        val sharedRecipesButton: Button = findViewById(R.id.button_shared_recipes)
        sharedRecipesButton.setOnClickListener {
            val intent = Intent(this, SharedRecipeActivity::class.java)
            startActivity(intent)
        }
    ...
    private fun retrieveAndDisplayUserName() {
        ...
        if (userId != null) {
            ...
            userRef.child("name").get().addOnSuccessListener { dataSnapshot ->
                ...
                if (userName != null) {
                    welcomeText.text = "Welcome to My Recipes, $userName"
                } else {
                    welcomeText.text = "Welcome to My Recipes"
                }
    ...
    private suspend fun shoveImagesToLocalStorage() = withContext(Dispatchers.IO) {
