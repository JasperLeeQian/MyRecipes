...
import com.example.myrecipes.model.Meal
import com.example.myrecipes.model.MealDbResponse
import com.example.myrecipes.onlinedb.RetrofitClient
...
class RandomMealActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_try_something_new)
    ...
    private fun fetchRandomMeal() {
        ...
        call.enqueue(object : Callback<MealDbResponse> {
            ...
            override fun onFailure(call: Call<MealDbResponse>, t: Throwable) {
                // Handle onlindb or other errors
                runOnUiThread {
